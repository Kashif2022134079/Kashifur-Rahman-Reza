    ...
    return (
        <div className="mb-4">
            ...
            <p className="md:text-lg text-base text-gray-600 mb-3">
                ...
                You can check my <a className="text-blue-600" href="https://www.linkedin.com/in/kashif79/">LinkedIn profile</a> for more about my journey and the projects I have worked on so far.
                <br /> <br />
